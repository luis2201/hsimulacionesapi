...
const validacionesReserva = [
  body('Semana').notEmpty().withMessage('Semana obligatoria'),
  ...
  body('NumEstudiantes').isInt({ min: 0 }).withMessage('Número de estudiantes no es válido'),
  body('TecnicoID').isInt().withMessage('Técnico no es válido'),
  body('RecursoID').isInt().withMessage('El recurso no es válido')
];
